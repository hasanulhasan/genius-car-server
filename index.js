  ...
  try {
    ...
    app.post("/orders", async (req, res) => {
      ...
      const data = {
        ...
        success_url: `https://genius-car-server-pi-one.vercel.app/payment/success?transactionId=${transactionId}`,
        fail_url: "https://genius-car-server-pi-one.vercel.app/payment/fail",
        cancel_url: "https://genius-car-server-pi-one.vercel.app/payment/cancel",
        ipn_url: "https://genius-car-55613.web.app/ipn",
    ...
    app.post("/payment/success", async (req, res) => {
      ...
      if (result.modifiedCount > 0) {
        res.redirect(
          `https://genius-car-55613.web.app/payment/success?transactionId=${transactionId}`
        );
      }
    });

    app.post("/payment/fail", async (req, res) => {
      res.redirect(`https://genius-car-55613.web.app/`);
    });
